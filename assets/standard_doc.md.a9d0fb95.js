import{_ as s,c as n,o as a,a as l}from"./app.c4e3427c.js";const d=JSON.parse('{"title":"文档规范","description":"","frontmatter":{},"headers":[{"level":2,"title":"项目文档","slug":"项目文档","link":"#项目文档","children":[]},{"level":2,"title":"组件文档","slug":"组件文档","link":"#组件文档","children":[]}],"relativePath":"standard/doc.md"}'),p={name:"standard/doc.md"},o=l(`<h1 id="文档规范" tabindex="-1">文档规范 <a class="header-anchor" href="#文档规范" aria-hidden="true">#</a></h1><p>在多人合作开发下，经常碰到的最头疼的问题是，其他开发者在交接给我们一个项目时只是对项目目前现有的功能简单的描述了下，我们在后续迭代功能时突然发现连最基本的项目如何运行都没有给我们交代，只能去查看 <code>package.json</code> 的 <code>scripts</code>，其他信息还得查看代码去意会。为了避免类似的情况，可想而知一份规范的文档说是多么的重要，所以文档规范的编写就是为了解决文档信息不全、编写杂乱等问题。</p><p>以下推荐项目说明文档和组件使用文档的编写规范。</p><h2 id="项目文档" tabindex="-1">项目文档 <a class="header-anchor" href="#项目文档" aria-hidden="true">#</a></h2><div class="language-md"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#89DDFF;"># </span><span style="color:#FFCB6B;">背景</span></span>
...
<span class="line"></span></code></pre></div><h2 id="组件文档" tabindex="-1">组件文档 <a class="header-anchor" href="#组件文档" aria-hidden="true">#</a></h2><div class="language-md"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#89DDFF;"># </span><span style="color:#FFCB6B;">组件名称</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">| ------ | ---- | -------- |</span></span>
<span class="line"><span style="color:#A6ACCD;">| -      | -    | -        |</span></span>
<span class="line"></span></code></pre></div>`,7),e=[o];function t(c,r,D,i,F,y){return a(),n("div",null,e)}const A=s(p,[["render",t]]);export{d as __pageData,A as default};
