import{_ as s,c as n,o as a,a as p}from"./app.8a49408b.js";const d=JSON.parse('{"title":"目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"standard/structure.md"}'),l={name:"standard/structure.md"},o=p(`<h1 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-hidden="true">#</a></h1><p>目录结构足够清晰的话，能够让开发者一目了然，知道什么文件夹是存在什么内容，做的是什么功能，也便于维护者的对代码的良好阅读，也能让开发者快速了解项目的基础架构的情况。</p><p>目前默认应用目录架构提供了良好的代码分层结构，适用于开发或大或小的应用，约定的目录结构如下：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">.</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p><strong>mock/</strong></p><p>本地模拟数据的目录。</p><p><strong>public/</strong></p><p>静态资源目录，默认包含 <code>index.html</code> 和 <code>favicon.png</code></p><p><strong>plop-templates</strong></p><p>基于 <a href="https://github.com/plopjs/plop" target="_blank" rel="noreferrer"><code>plop</code></a> 生成器框架，快速生成模板文件</p><p><strong>src/</strong></p><p>源码目录</p><p><strong>assets/</strong></p><p>项目的静态资源目录，通常包括图片、<code>Svg</code> 图标、<code>Font</code> 字体三部分，目录形式如下：</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#FFCB6B;">assets</span></span>
...
<span class="line"></span></code></pre></div><p><strong>layouts/</strong></p><p>项目的布局文件目录，布局通常包含导航配置，布局组件，样式三部分，推荐的目录形式如下：</p><p><strong>components/</strong></p><p>项目通用的组件目录，其中如基础类型的组件，命名<code>x-[component-name]</code>，目录推荐形式如下：</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#FFCB6B;">XIcon</span></span>
...
<span class="line"></span></code></pre></div><p><strong>views/</strong></p><p>项目的页面文件目录，页面通常包页面、业务组件，目录形式推荐如下:</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#FFCB6B;">user</span><span style="color:#A6ACCD;">                     </span><span style="color:#676E95;font-style:italic;"># uer 页面</span></span>
...
<span class="line"></span></code></pre></div><p><strong>store/</strong></p><p>基于<code>Pinia(Vuex5)</code>的数据状态管理层，目录形式推荐如下:</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#FFCB6B;">store</span></span>
