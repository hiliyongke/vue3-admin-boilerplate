...
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>.stylelintrc.js \u53C2\u8003\u4F8B\u5B50</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">module.exports = {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>.prettierrc.js \u53C2\u8003\u4F8B\u5B50</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">module.exports = {</span></span>
<span class="line"><span style="color:#A6ACCD;">  </span></span>
...
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>.eslintignore \u53C2\u8003\u4F8B\u5B50</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">dist</span></span>
<span class="line"><span style="color:#A6ACCD;">node_modules</span></span>
<span class="line"><span style="color:#A6ACCD;">package.json</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>.stylelintignore \u53C2\u8003\u4F8B\u5B50</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">dist</span></span>
<span class="line"><span style="color:#A6ACCD;">node_modules</span></span>
<span class="line"><span style="color:#A6ACCD;">package.json</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>.prettierignore \u53C2\u8003\u4F8B\u5B50</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">dist</span></span>
<span class="line"><span style="color:#A6ACCD;">node_modules</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p><strong>[4].package.json \u4E2D\u914D\u7F6E\u4F7F\u7528</strong> \u4F8B\u5982\uFF1A</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">  &quot;scripts&quot;: {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  },</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><hr><h3 id="git-\u5DE5\u4F5C\u6D41\u89C4\u8303\u5B9E\u8DF5" tabindex="-1"><a href="#git%E5%B7%A5%E4%BD%9C%E6%B5%81%E8%A7%84%E8%8C%83%E5%AE%9E%E8%B7%B5"></a>GIT \u5DE5\u4F5C\u6D41\u89C4\u8303\u5B9E\u8DF5 <a class="header-anchor" href="#git-\u5DE5\u4F5C\u6D41\u89C4\u8303\u5B9E\u8DF5" aria-hidden="true">#</a></h3><h4 id="_1-\u5B89\u88C5-git-\u5DE5\u4F5C\u6D41\u89C4\u8303\u4F9D\u8D56" tabindex="-1"><a href="#1-%E5%AE%89%E8%A3%85git%E5%B7%A5%E4%BD%9C%E6%B5%81%E8%A7%84%E8%8C%83%E4%BE%9D%E8%B5%96"></a>1. \u5B89\u88C5 GIT \u5DE5\u4F5C\u6D41\u89C4\u8303\u4F9D\u8D56 <a class="header-anchor" href="#_1-\u5B89\u88C5-git-\u5DE5\u4F5C\u6D41\u89C4\u8303\u4F9D\u8D56" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">tnpm install husky lint-staged @commitlint/config-conventional  @commitlint/lint  git-repo-info --save-dev</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h4 id="_2-git-\u5DE5\u4F5C\u6D41\u89C4\u8303\u914D\u7F6E\u6B65\u9AA4" tabindex="-1"><a href="#2-git%E5%B7%A5%E4%BD%9C%E6%B5%81%E8%A7%84%E8%8C%83%E9%85%8D%E7%BD%AE%E6%AD%A5%E9%AA%A4"></a>2. GIT \u5DE5\u4F5C\u6D41\u89C4\u8303\u914D\u7F6E\u6B65\u9AA4 <a class="header-anchor" href="#_2-git-\u5DE5\u4F5C\u6D41\u89C4\u8303\u914D\u7F6E\u6B65\u9AA4" aria-hidden="true">#</a></h4><p><strong>\u30101\u3011\u5728 packgae.json \u4E2D\u6DFB\u52A0 prepare \u811A\u672C</strong></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p><strong>\u30104\u3011lint-staged \u914D\u7F6E</strong></p><p>\u5728\u9879\u76EE\u76EE\u5F55\u4E0B\u65B0\u5EFA. lintstagedrc.json \u5728\u6587\u4EF6\u4E2D\u914D\u7F6E\u76F8\u5173\u5185\u5BB9\u5373\u53EF\u6216\u8005\u76F4\u63A5\u5728 package.json \u4E2D\u914D\u7F6E .lintstagedrc.json \u53C2\u8003\u4F8B\u5B50</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">};</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>package.json \u53C2\u8003\u4F8B\u5B50</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>\u4F7F\u7528 npm run changelog\uFF0C\u5C31\u80FD\u751F\u6210\u4E00\u4EFD\u66F4\u6539\u65E5\u5FD7 <a href="http://CHANGELOG.md" target="_blank" rel="noreferrer">CHANGELOG.md</a>\u3002</p><h3 id="\u603B\u7ED3" tabindex="-1"><a href="#%E6%80%BB%E7%BB%93"></a>\u603B\u7ED3 <a class="header-anchor" href="#\u603B\u7ED3" aria-hidden="true">#</a></h3><p>\u524D\u7AEF\u5DE5\u7A0B\u5316\u4E4B\u4EE3\u7801\u7F16\u5199\u89C4\u8303\u548C GIT \u5DE5\u4F5C\u6D41\u89C4\u8303\u662F\u6BCF\u4E2A\u56E2\u961F\u5E94\u8BE5\u6709\u7684\u4E00\u4E2A\u73AF\u8282\u800C\u4E14\u662F\u5F88\u91CD\u8981\u7684\u4E00\u4E2A\u73AF\u8282\uFF0C\u6B64\u89C4\u8303\u7EA6\u675F\u4E86\u5F00\u53D1\u8005\u7684\u7F16\u7801\u548C\u63D0\u4EA4\u89C4\u8303\u3002\u505A\u597D\u8FD9\u4E9B\u4F1A\u8BA9\u5F00\u53D1\u8005\u4E0D\u7BA1\u5728\u4EE3\u7801\u7684\u63D0\u5347\u4E0A\u6709\u6240\u5E2E\u52A9\uFF0C\u800C\u4E14\u4E5F\u80FD\u5728 code review \u6216\u8005\u56DE\u6EAF\u4EE3\u7801\u65F6\u63D0\u4F9B\u79EF\u6781\u4F5C\u7528\u3002</p>`,84),t=[e];function o(c,i,r,C,A,y){return a(),n("div",null,t)}const D=s(p,[["render",o]]);export{g as __pageData,D as default};
