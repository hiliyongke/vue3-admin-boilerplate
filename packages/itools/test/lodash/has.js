...
describe('has', function () {
  lodashStable.each(['has'], function (methodName) {
    ...
    it(
      '`itools.' + methodName + '` should check for own properties',
      function () {
        let object = { a: 1 };
    ...
    it(
      '`itools.' +
        methodName +
        '` should not use the `hasOwnProperty` method of `object`',
      function () {
    ...
    it(
      '`itools.' + methodName + '` should work with `arguments` objects',
      function () {
    ...
    it(
      '`itools.' + methodName + '` should work with a non-string `path`',
      function () {
        let array = [1, 2, 3];
    ...
    it(
      '`itools.' + methodName + '` should preserve the sign of `0`',
      function () {
        let object = { '-0': 'a', 0: 'b' };
    ...
    it(
      '`itools.' + methodName + '` should work with a symbol `path`',
      function () {
        function Foo() {}
    ...
    it(
      '`itools.' + methodName + '` should check for a key over a path',
      function () {
        let object = { 'a.b': 1 };
    ...
    it(
      '`itools.' +
        methodName +
        '` should return `false` when `object` is nullish',
      function () {
    ...
    it(
      '`itools.' +
        methodName +
        '` should return `false` over sparse values of deep paths',
      function () {
        let values = [sparseArgs, sparseArray, sparseString];
        let expected = lodashStable.map(
          values,
          lodashStable.constant([false, false])
        );
