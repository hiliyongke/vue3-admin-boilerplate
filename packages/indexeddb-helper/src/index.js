...
export class IndexedDbHelper {
  constructor(options = {}) {
    ...
    // const store = new IndexedDbHelper()
...
IndexedDbHelper.deleteDatabase = function (name) {
  return new Promise((resolve, reject) => {
...
IndexedDbHelper.databases = function () {
  return indexedDB.databases();
};

export default IndexedDbHelper;

export class IndexedDbHelperStore {
  constructor(options = {}) {
