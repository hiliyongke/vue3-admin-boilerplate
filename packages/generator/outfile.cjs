...
var require_style = __commonJS({
  '../../node_modules/.pnpm/prompts@2.4.2/node_modules/prompts/dist/util/style.js'(
    ...
    var item = (expandable, expanded) =>
      c.gray(
        expandable ? (expanded ? figures.pointerSmall : '+') : figures.line
      );
    module2.exports = {
      styles,
      render,
...
`
      ...
      paginateOptions(options2) {
        ...
        for (let i = startIndex; i < endIndex; i++) {
          ...
          styledOptions.push(
            this.renderOption(this.cursor, options2[i], i, prefix)
          );
        }
        return '\n' + styledOptions.join('\n');
      }
        ...
        this.filteredOptions = this.value.filter(v => {
          if (this.inputValue) {
            if (typeof v.title === 'string') {
              if (
                v.title.toLowerCase().includes(this.inputValue.toLowerCase())
              ) {
                return true;
              }
            }
            if (typeof v.value === 'string') {
              if (
                v.value.toLowerCase().includes(this.inputValue.toLowerCase())
              ) {
                return true;
              }
            }
  ...
  '../../node_modules/.pnpm/prompts@2.4.2/node_modules/prompts/lib/index.js'(
    ...
    async function prompt(
      ...
      const getFormattedAnswer = async (
        ...
        return question2.format
          ? await question2.format(answer2, answers)
          : answer2;
      };
...
var require_impl = __commonJS({
  '../../node_modules/.pnpm/git-clone@0.2.0/node_modules/git-clone/private/impl.js'(
    ...
    module2.exports = function clone2(
      repo,
      targetPath,
      opts,
      onSuccess,
...
var require_templates = __commonJS({
  '../../node_modules/.pnpm/chalk@4.1.2/node_modules/chalk/source/templates.js'(
    ...
    module2.exports = (chalk, temporary) => {
      ...
      temporary.replace(
        TEMPLATE_REGEX,
        (m, escapeCharacter, inverse2, style, close, character) => {
          if (escapeCharacter) {
  ...
  '../../node_modules/.pnpm/chalk@4.1.2/node_modules/chalk/source/index.js'(
    ...
    var applyOptions = (object, options2 = {}) => {
      if (
        options2.level &&
        !(
          Number.isInteger(options2.level) &&
          options2.level >= 0 &&
          options2.level <= 3
        )
      ) {
...
function canSafelyOverwrite(dir) {
  return (
    !import_fs2.default.existsSync(dir) ||
    import_fs2.default.readdirSync(dir).length === 0
  );
}
    ...
    result = await (0, import_prompts.default)(
      [
        ...
        },
        {
          ...
          type: () =>
            canSafelyOverwrite(String(targetDir)) || forceOverwrite
              ? null
              : 'confirm',
          message: () => {
            const dirForPrompt =
...
`);
  if (root !== cwd) {
    console.log(
      `   ${bold(green(`cd ${import_path2.default.relative(cwd, root)}`))}`
    );
  }
