 ...
 * */
export const useTable = (apiUrl: (params: any) => Promise<any>, initParam: any = {}, isPagination = true) => {
  ...
  const updatedTotalParam = () => {
    ...
    Object.assign(state.totalParam, nowSearchParam, isPagination ? pageParam.value : {});
  };
