<template>
  <div class="col-box">
    ...
    <NodeMain v-if="node && node.childNode" :node="node.childNode" :add-node="addNode" :delete-node="deleteNode" />
    <div v-if="index === parentLength - 1" class="top-right-cover-line"></div>
    <div v-if="index === parentLength - 1" class="bottom-right-cover-line"></div>
  </div>
</template>
